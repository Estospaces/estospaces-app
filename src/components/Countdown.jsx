...
const Countdown = () => {
    return (
        <section className="py-32 bg-gradient-to-br from-primary/5 via-orange-50 to-primary/10 relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="max-w-5xl mx-auto text-center">
                    ...
                    <h2 className="text-5xl md:text-7xl font-bold mb-6 tracking-tight">
                        <span className="text-secondary">We're Launching </span>
                    ...
                    <div className="inline-block relative group">
                        ...
                        <div className="relative bg-white px-10 py-5 rounded-full border-2 border-primary/20 shadow-xl transform group-hover:-translate-y-1 transition-all duration-300">
